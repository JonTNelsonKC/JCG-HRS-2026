...
function baseSources(season = getSeason()) {
  return [
    {
...
function dashboardSources(currentRace, season = getSeason()) {
...
async function getRaceDashboard() {
  ...
  const normalized = normalizeRace(selectedRace, weekendFeed, liveFeed, errors);
...
export async function buildDashboard() {
  ...
  return {
    ...
    assets: ASSETS,
    sources: dashboardSources(currentRace, season),
    warnings,
    ...driverData,
    currentRace
  };
